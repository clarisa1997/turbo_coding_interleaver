...
HD_PWD='C:/Users/clari/project_interleaver_final/project_interleaver_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interleaver_1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interleaver_1024.tcl
